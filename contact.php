  ...
  <div class="content-nav_container">
    <div class="content-nav_content">
      <div>
        <h1>Contact</h1>
        <hr>
        <p>If you need to contact me for some reason you can do so at: contact@osuoverlay.tk</p>
        <p>You can also reach out on discord: <div class="exampleLink">carl#7960</div><p>
      </div>
    </div>
  </div>
</body>
